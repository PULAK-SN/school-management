...
import { createSubject, updateSubject } from "@/lib/server-action";
...
const SubjectForm = ({
  ...
  type SubjectFormValues = z.input<typeof subjectSchema>; // before coercion
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = handleSubmit((data) => {
    console.log(data);
    const parsed = subjectSchema.parse(data); // ✅ ensures coercion and type safety
    action(parsed);
  });
